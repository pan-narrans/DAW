...
// SETTERS	
	...
	public void setDescripcion (String descripcion)  throws IllegalArgumentException {
		if (descripcion == "")  throw new IllegalArgumentException("Exception: Descripci�n vac�a");
	...
	public void setRetencionTipo(double retencionTipo) throws IllegalArgumentException {
		if (retencionTipo < 0.0 || retencionTipo > 1.0) throw new IllegalArgumentException("Exception: Retenci�n incorrecta");
...
//calculaFactura
	...
	private void calcularFactura () {		
	 	...
	 	double facturable = total - retencion;// Lo facturable es el total menos la retenci�n
