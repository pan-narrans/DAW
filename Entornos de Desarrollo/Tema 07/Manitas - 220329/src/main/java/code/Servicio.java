...
// CONSTRUCTORES	
  ...
  public Servicio(int id, String fecha, String descripcion, double horas, Colaborador colaborador, Cliente cliente) {
  	this.setId(id);
  	this.setFecha(fecha);
...
// SETTERS
	...
	public void setFecha(String fecha) {
		try {
			if (fecha == "") throw new IllegalArgumentException("Exception: Fecha incorrecta");
			this.fecha = fecha;}
