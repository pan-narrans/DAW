...
/** 
* M�todos auxiliares para validar valores
...
// NIF	
  ...
  /** 
	...
	*/		  		
	...
	private static String letraDNI(String numerosDNI) throws IllegalArgumentException {
		...
		if (numerosDNIint < NIFMin || numerosDNIint > NIFMax) {throw new IllegalArgumentException("Exception: Numeros del DNI no v�lidos");}
  ...
  /** 
	...
	* @throws IllegalArgumentException Si el NIF est� vac�o
	*/		  		
	
	public static boolean validarNIF(String NIF) throws IllegalArgumentException {
		if (NIF == "" || NIF == null) {throw new IllegalArgumentException("Exception: NIF vac�o");}
...
* @throws IllegalArgumentException Si el nombre est� vac�o
*/		  			
		
  public static boolean validarNombre(String nombre) throws IllegalArgumentException {
		if (nombre == "" || nombre == null) {throw new IllegalArgumentException("Exception: Nombre vac�o");}
...
* @throws IllegalArgumentException Si el eMail est� vac�o
*/		  		
	
  public static boolean validarEMail(String eMail)  throws IllegalArgumentException {
		if (eMail == "" || eMail == null) {throw new IllegalArgumentException("Exception: eMail vac�o");}
...
* @throws IllegalArgumentException Si la fecha est� vac�o
*/		  		
...
// Me quito morralla con un regex		
		String regex = "^[0-3]{1}[0-9]{1}/[0-1]{1}[1-9]{1}/[0-9]{4}$"; // regex de una pseudo fecha: dd/mm/yyyy
    Pattern p = Pattern.compile(regex);
...
// Genera una lista de 100 pseudo-NIFs e imprime s�lo los v�lidos  	
