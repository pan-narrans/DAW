...
// CONSTRUCTOR
	...
	public ColaboradorReal(
		int id, ServicioTipos servicio, Scoring scoring, double tarifa, boolean disponible, // Propios del colaborador
		 String NIF, String nombre, int telefono, String eMail) throws IllegalArgumentException { // Heredados de persona
...
//esActivo
	public boolean esActivo() {
		...
		tarifaMax = this.servicio.getTarifa()*(1-this.scoring.getRebaja()); // Calcula la tarifa máxima para el servicio y scoring del colaborador
		if (this.disponible && this.tarifa <= tarifaMax) activo = true; // El colaborador está activo si está disponible y su tarifa no sobrepasa el máximo para ese scoring y servicio
		return activo;}
...
/*	
	public static void main(String[] args) {
		...
		ColaboradorReal colaborador = new ColaboradorReal(1,ServicioTipos.ALBAÑIL,Scoring.ALTO,10,true,"12345678X","Capitan America",777777777,"capitanamerica@gmail.com");
