...
//0. Excepciones
	...
	Factura facturaVacia = new Factura();
		...
		try {
			...
			argId = Math.abs(argId) + 1;} // Evita fallidos al crear la facturaTest
		...
		try {
			...
			argFecha = Aleatorio.darString(10);} // Mejorable: una fecha "ver�dica"
		...
		try {
  		...
  		argDescripcion = Aleatorio.darString(10);}	// Una descripción cualquiera
		...
		try {
  		...
  		argBase = Math.abs(argBase) + 1.0;} // La base en positivo (ha fallado por ser negativa o cero
		...
		try {
  		...
  		argIvaTipo = Aleatorio.darDouble(0.0, 1.0, 1);} // Un valor entre 0 y 1
		...
		try {
  		...
  		argRetencionTipo = Aleatorio.darDouble(0.0, 1.0, 1);}  // Un valor entre 0 y 1
