...
// SETTERS	
	...
	public void setFecha(String fecha) throws IllegalArgumentException{
		if (fecha == "")  throw new IllegalArgumentException("Exception: Fecha Vacía"); // Mejorable: foramatos fecha
		this.fecha = fecha;}
...
// MAIN	
	public static void main(String[] args) {
		Factura factura = new Factura(1,"19/03/2022","X00000000","35223355R","Rotura de Tuberia",1000,0.21,0.20);
